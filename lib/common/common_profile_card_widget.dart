      ...
      child: Row(
        ...
        children: [
            ...
            children: [
              ...
              Column(
                ...
                children: [
                  ...
                  Container(
                    padding: responsivePadding(context, verticalFactor: 0.01, horizontalFactor: 0.02),
                    decoration: BoxDecoration(
          ...
          Row(
            crossAxisAlignment: CrossAxisAlignment.end,
            children: [
              Icon(Icons.location_on_outlined, color: Colors.white54, size: getResponsiveFontSize(context, 14)),
              kWidth(context, 0.01),
              CustomText(
                text: location,
