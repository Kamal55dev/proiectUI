import 'package:badminton/modules/player_module/player_matches/view/player_match_scroring_page.dart';
import 'package:flutter/material.dart';
import 'package:flutter_riverpod/flutter_riverpod.dart';

class RakPodium extends ConsumerWidget {
  const RakPodium({super.key});
      ...
      children: [
        ...
        Row(
          ...
          children: [
            ...
            Image.asset(
              'assets/images/player_images/rak_podium_image.png',
              height: 145,
              width: 145,
            ),
          ],
